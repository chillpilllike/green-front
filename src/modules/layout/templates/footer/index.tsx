...
import Head from "next/head" // Import next/head to add scripts
...
export default async function Footer() {
  ...
  return (
    <>
      {/* Insert external Reamaze script in the Head */}
      <Head>
        <script
        ...
        ></script>
        {/* Inline script for configuring Reamaze widget */}
        <script
          type="text/javascript"
          dangerouslySetInnerHTML={{
            __html: `
              ...
              _support['ui']['widget'] = {
                ...
                slug: 'secretgreen-au-chat-slash-contact-form-shoutbox',
                label: {
